                                ...
                                <div class="col-md-12">
                                    <div class="card shadow">
                                        <div class="card-header">
                                            <h2 class="mb-0">Form Tambah Supplier</h2>
                                        </div>
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="name" name="name" type="text" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" placeholder="Fill your supplier or distributor." value="{{ old('name') }}" required autofocus>
                                                        @if ($errors->has('name'))
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="address" name="address" type="text" class="form-control{{ $errors->has('address') ? ' is-invalid' : '' }}" placeholder="Fill your supplier address  or distributor." value="{{ old('address') }}" required >
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="telp" name="telp" type="text" class="form-control{{ $errors->has('telp') ? ' is-invalid' : '' }}" placeholder="Fill your supplier phone number or distributor." value="{{ old('telp') }}" required>
                                                        @if ($errors->has('telp'))
                                                            <span class="invalid-feedback" role="alert">
